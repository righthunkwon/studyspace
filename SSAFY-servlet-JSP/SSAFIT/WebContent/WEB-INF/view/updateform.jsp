...
<body>
	...
	<div class="homeimages">
		...
		<div class="review-container">
			...
			<div class="small-empty"></div>
			<div id="formdiv">
				<form action="main?action=update" method="POST" class="review-form">
					<input type="hidden" name="vid" value="${video.id }">
					<input type="hidden" name="rid" value="${review.id }">
					<div class="form-group">
						<label for="title">제목:</label> <input type="text" name="title"
							id="title" value="${review.title }" class="form-control">
					</div>
					<div class="form-group">
						<label for="writer">작성자:</label> <input type="text" name="writer"
							id="writer" value="${review.writer }"class="form-control">
					</div>
					<div class="form-group">
